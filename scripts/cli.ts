...
class D2ECli {
  version: string;
  LATEST_DOCKER_TAG_NAME: string = "0.18.10-beta"; // Update this as needed
  ...
  // set. webapi-init globs whatever it finds (`for f in /scripts/*.sql`)
  // instead of reading a manifest, so a script a previous CLI version staged
  // would still be executed -- and under ON_ERROR_STOP=1 one that no longer
  // applies fails the whole init.
  //
